...
const Instamart = () => {
  ...
  return (
    <>
      <div style={{ margin: "10%" }}>
        <div className="menu-label" style={{ fontSize: "36px", color: "grey" }}>
          Blog
        </div>
        ...
        <Accordian
          title={"Health"}
          description={
            'Health is a positive concept that emphasizes both social and personal resources as well as physical abilities." This means that health is a resource to help an individual perform their function in society, rather than an end in itself. A healthy lifestyle allows you to live a full life with meaning and purpose.'
          }
